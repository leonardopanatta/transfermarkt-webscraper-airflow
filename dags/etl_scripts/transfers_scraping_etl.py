...
class TransfersScrapingETL():
    ...
    def scrape_latest_transfers(self, clubs_from_country):
        ...
        url = "https://www.transfermarkt.com.br/transfers/neuestetransfers/statistik/plus/?plus=1&galerie=0&wettbewerb_id=alle&land_id="+land_id+"&minMarktwert=0&maxMarktwert=200.000.000&yt0=Mostrar"
        ...
        #clubs_left_nationalities = soup.select("table.items > tbody > tr > td:nth-of-type(4) > table > tr:nth-of-type(2) > td > img")
        #clubs_left_leagues = soup.select("table.items > tbody > tr > td:nth-of-type(4) > table > tr:nth-of-type(2) > td > a")
        ...
        #clubs_joined_nationalities = soup.select("table.items > tbody > tr > td:nth-of-type(5) > table > tr:nth-of-type(2) > td > img")
        #clubs_joined_leagues = soup.select("table.items > tbody > tr > td:nth-of-type(5) > table > tr:nth-of-type(2) > td > a")
